...
const Sidebar = ({
  ...
  return (
    <aside className="w-full md:w-1/2 lg:w-1/3 bg-green-600 text-white p-8 flex flex-col justify-center items-center text-center">
    
      {/* Title */}
      <h1 className="text-3xl font-bold mb-4">We are Hiring</h1>
